	...
	$sql = "SELECT * FROM map_tbl  WHERE validate=1 AND disease LIKE '%$selectedDisease%'";
	// Date filter
	...
	<div id="floating-panel">
		...
		<?php
			...
			$sqlDisease = "SELECT disease, count(disease) count FROM map_tbl GROUP BY disease";
	...
	<div class="col-xs-6" id="pinpoint"> 	
		...
		<br>		
		<form action="Superadmapp.php" name="pinpointForm" method="post">
			...
			<?php
			$sql = "SELECT distinct(address) FROM map_tbl";
