        ...
        <div class="card mb-3">
          ...
          <div class="card mb-3" id="firstDiv" >
              <div class="card-body">
                ...
                <form name="filter" method="POST" action="demoadmin.php#firstDiv">
        ...
        <div class="card mb-3">
          ...
          <div class="card mb-3" id="secondDiv">
              <div class="card-body">
                ...
                <form name="filter" method="POST" action="demoadmin.php">
                    <div class="d-inline-block">
                    <p>Filter the dashboard:</p>
                    </div>
                    <div class="d-inline-block">
          ...
          <!-- end -->
           ...
           <div class="card mb-3">
            <div class="card-header "style="background-color:#4385C7; color: white;">
              <i class="fas fa-table"></i>  Bar Graph for Crowd Sourcing
            </div>
            <div style="width: 100%; height: 400px;">
            <!-- Example Pie Chart Card-->
            <div class="card mb-3" id="fourDiv" >
                <div class="card-body">
                  ...
                  <form name="filter" method="POST" action="superadmin-demoadmin" hidden>
                      <div class="d-inline-block">
                      <p>Filter the dashboard:</p>
                      </div>
                      <div class="d-inline-block">
